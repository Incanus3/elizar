defmodule ElizarWeb.Router do
  ...
  scope "/", ElizarWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ElizarWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ElizarWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ElizarWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", ElizarWeb do
    ...
    live_session :current_user,
      on_mount: [{ElizarWeb.UserAuth, :mount_current_user}] do
